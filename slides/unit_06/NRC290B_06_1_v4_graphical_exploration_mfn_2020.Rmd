...
<!-- `r here(slide_img_dir, "runavg.pdf")` -->
<!-- `r plot(bp$Poop, lwd=2,col=4,bty="l",las=1,ylab="Running Average", xlab="no. of samples", ylim=c(0,2), type="l");     lines(bp$Bear, lwd=2,col=2,bty="l",las=1,ylab="Running Average", xlab="no. of samples");                abline(h=mean(bp$Bear), lty=2, col=2);                abline(h=mean(bp$Poop), lty=2, col=4); legend("bottomright", lwd=2,col=c(4,2),legend=c("Poop","bear"), bty="n")` -->
