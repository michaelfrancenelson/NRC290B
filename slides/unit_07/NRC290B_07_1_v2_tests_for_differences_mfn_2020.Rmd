...
Scenario: You want to know whether the growth rates of oak trees differ in two habitats.  You have two clones each of 37 different genotypes.  One clone of each genotype is planted in a mesic prairie, the other in an old agricultural field.
...
Scenario: You are testing whether Pennsylvania sedge (C. pennsylvanica) cover is greater under hardwoods or conifers.  You have collected percent cover data from 50 hardwood and 50 conifer patches at Mount Toby.
...
Scenario: You want to know whether the growth rates of oak trees differ in two habitats.  You think they will grow more quickly in a old agricultural field than in a mesic prairie.
...
Scenario: You want to know whether the growth rates of oak trees differ in two habitats: an old agricultural field and mesic prairie.
...
<!-- Scenario: You calculate a t-value, and an associated p-value, for individual length in two populations of Daphnia.  Which critical significance category for the t-value would give you the best evidence that the two populations are different: -->
...
- Statistics is the tool we use to formally answer these questions!
    - Ahe differences *are*/*are not* significant!
